...
ids<-read.table(paste0(path, "Case ids Email 1.txt"), stringsAsFactors = FALSE)
ids<-ids$V1
...
write.table(Merged_out_loader, file = paste0(path,"dates from children email 1.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
