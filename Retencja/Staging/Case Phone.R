...
ids<-read.table(paste0(path, "Case ids Phone.txt"), stringsAsFactors = FALSE)
ids<-ids$V1
...
Merged_out1<-Merged_out_loader[1:500000,]
Merged_out2<-Merged_out_loader[500001:1000000,]
Merged_out3<-Merged_out_loader[1000001:1500000,]
Merged_out4<-Merged_out_loader[1500001:2000000,]
Merged_out5<-Merged_out_loader[2000001:2500000,]
Merged_out6<-Merged_out_loader[2500001:3000000,]
Merged_out7<-Merged_out_loader[3000001:length(Merged_out[[1]]),]



write.table(Merged_out1, file = paste0(path,"dates from children phone 1.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
write.table(Merged_out2, file = paste0(path,"dates from children phone 2.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
write.table(Merged_out3, file = paste0(path,"dates from children phone 3.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
write.table(Merged_out4, file = paste0(path,"dates from children phone 4.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
write.table(Merged_out5, file = paste0(path,"dates from children phone 5.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
write.table(Merged_out6, file = paste0(path,"dates from children phone 6.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
write.table(Merged_out7, file = paste0(path,"dates from children phone 7.csv"), quote = TRUE, row.names = FALSE, col.names = TRUE, sep = ",", na = "")
